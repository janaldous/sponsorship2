...
class CompanyHouseFetchServiceIT {
	...
	@Test
	void test() {
		List<PDFSponsor> computerProgrammingSponsors = pdfSponsorRepository.findAllByFetchStatusAndDateUpdatedIsNull(FetchDataStatus.MULTIPLE_RESULT, PageRequest.of(0, 600));
